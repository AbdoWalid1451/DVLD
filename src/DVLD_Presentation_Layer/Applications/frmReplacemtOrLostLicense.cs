...
{
    public partial class frmReplacemtOrLostLicense : Form
    {
        public frmReplacemtOrLostLicense()
        {
            InitializeComponent();
        }
        ...
        private int CreateApplicationForNewLicense()
        {
            clsApplicationType applicationType;
            if (rbDamagedLic.Checked)
                applicationType = clsApplicationType.Find("Replacement for a Damaged Driving License");
            else
                applicationType = clsApplicationType.Find("Replacement for a Lost Driving License");
        ...
        private void FillInfoForInterLicense(clsLicense newLicense)
        {
            ...
            newLicense.ApplicationID = CreateApplicationForNewLicense();
            ...
            if (rbDamagedLic.Checked)
                newLicense.IssueReason = clsLicense.enIssueReason.ReplaceForDamaged;
            else
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (NewLicense.Save())
            {
                ...
                ctrlDamageOrReplacementLicenseApp1.LoadBasicOldLicense(NewLicense.LicenseID);
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            if (ctrlDriverLicenseInfoWithFilter1.license != null)
            {
                ...
                ctrlDamageOrReplacementLicenseApp1.LoadBasicOldLicense(ctrlDriverLicenseInfoWithFilter1.license.LicenseID);
            }
            else
